...
public class RestController  
{
	...
	@RequestMapping(path = "/calculosOP", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public List<CalculoCombustible> calculosCombustibles()
	{
		return calculoCombustibleService.listar();		
	}
